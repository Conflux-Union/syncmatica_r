package ch.endte.syncmatica.client.hud;

import ch.endte.syncmatica.Context;
import ch.endte.syncmatica.ServerPlacement;
import ch.endte.syncmatica.Syncmatica;
import ch.endte.syncmatica.client.HudPreferences;
...
public final class MaterialHudOverlay implements HudRenderCallback {
    ...
    private void refreshSnapshot() {
        ...
        header = rows.isEmpty() ? null : StringUtils.translate("syncmatica.hud.claimed_header");
        needsRefresh = false;
    }
...
//#endif
    ...
    private String formatMissingVerboseText(final SyncmaticaMaterialEntry entry, final ItemStack stack) {
        ...
        return StringUtils.translate("syncmatica.gui.label.material.missing.compact", boxes, stacks, singles);
    }
