...
public class GuiSyncmaticaSharedSettings extends GuiBase {
    ...
    public GuiSyncmaticaSharedSettings() {
        title = StringUtils.translate("syncmatica.gui.title.shared_settings");
    }
    ...
    public void initGui() {
        ...
        final String backLabel = StringUtils.translate("syncmatica.gui.button.back");
    ...
    private static final class HudScaleSliderCallback implements ISliderCallback {
        ...
        public String getFormattedDisplayValue() {
            return StringUtils.translate("syncmatica.gui.label.hud_scale_value",
